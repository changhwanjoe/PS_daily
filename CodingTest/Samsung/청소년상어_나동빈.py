...
def move_all_fishes(array, now_x,now_y):
    # 1번부터 16번 까지의 물고기를 차례대로 낮은번호부터 확인
    for i in range(1,17):
        # 해당 물고기의 위치 찾기
...
def dfs(array,now_x,now_y,total):
    ...
    array[now_x][now_y][0] = -1 # 물고기를 먹었으므로 번호값 -1 qksghks

    move_all_fishes(array,now_x,now_y) # 전체 물고기 이동시키기

    # 이제 상어가 이동할 차례므로 이동 가능한 위치 찾기
